...
x_coords = {ax, bx, cx, dx, ex, fx, gx, hx, ix, jx, kx, lx, mx, nx, ox, ...
    px, qx, rx, sx, tx, ux, vx, wx, xx, yx, zx};
y_coords = {ay, by, cy, dy, ey, fy, gy, hy, iy, jy, ky, ly, my, ny, oy, ...
    py, qy, ry, sy, ty, uy, vy, wy, xy, yy, zy};
